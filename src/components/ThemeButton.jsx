            ...
            <div className="theme-display duration-150 w-full h-full flex items-center">
                <label
                    ...
                    className={`rounded-full relative duration-150 h-[24px] w-[46px] ${
                        dark ? "bg-bg-color" : "bg-secondary-text-color "
                    }  cursor-pointer`}
                >
                    <div
                        className={`circle overflow-hidden duration-250 w-[20px] absolute h-[20px] rounded-full flex items-center justify-center top-[50%]  ${
                            dark
                                ? "bg-box-color left-[100%] translate-x-[-110%] translate-y-[-50%]"
                                : "bg-text-color left-0 translate-x-[10%]  translate-y-[-50%]"
                        }`}
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            className={`sun size-5 duration-300 text-black absolute ${
                                !dark ? "mt-[0%]" : "mt-[-180%]"
                            }`}
                        >
                        ...
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            className={`moon size-5 duration-300  bg-white ${
                                dark ? "mt-[0%]" : "mt-[180%]"
                            } absolute`}
                        >
